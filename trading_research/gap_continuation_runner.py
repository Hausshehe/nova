"""Run the frozen opening-gap continuation hypothesis once."""
...
from .gap_continuation import HYPOTHESIS, signal
...
def main() -> int:
    ...
    parser.add_argument("--output", default="gap_continuation_experiment.json")
    ...
    record = run_experiment(
        ...
        strategy_version="positive-opening-gap-v1",
        memory_store=memory,
    )
