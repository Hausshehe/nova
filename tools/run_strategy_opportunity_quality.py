...
from trading_research.strategy_opportunity_quality import evaluate_strategy_opportunity_quality
...
def main() -> None:
    ...
    report = evaluate_strategy_opportunity_quality(bars)
    payload = {"schema_version": 1, "dataset": dataset, **report}
